Public Class Form1
    ...
    Private Sub [boolean] isMill(sender As Object, e As EventArgs)
        If Button1.BackColor = Color.White And Button2.BackColor = Color.White And Button3.BackColor = Color.White Then
            Return True
        End If
    End Sub
